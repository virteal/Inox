...
function inox( state, event, source ){
    ...
    // be efficient.
      ...
      // When the type is "list", the name is address of the rest of the list, if any.
      ...
      function task(){
        ...
        this.call_stack = new Uint32Array( 32 ); // Call stack is a small array of cell addresses
      ...
      if( source ){
        // Swtich to compile time dictionary
